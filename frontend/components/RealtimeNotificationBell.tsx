...
export const RealtimeNotificationBell = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = socketIO.subscribe('notification', (notification: any) => {
      ...
      // Add to persistent notifications in dropdown
      setNotifications((prev) => [newNotification, ...prev]);
      
      // Also add to toast for temporary display (3 seconds)
  ...
  return (
    <>
      ...
      <div className="fixed right-4 top-4 z-50">
        ...
        {/* Dropdown Panel */}
        {isOpen && (
          <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-900 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 z-50 max-h-[500px] flex flex-col">
            {/* Header */}
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800">
              <div>
                <h3 className="font-semibold text-lg">Notifications</h3>
                  ...
                  {notifications.map((notification) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <button
                          onClick={() => deleteNotification(notification.id)}
                          className="flex-shrink-0 ml-2 opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                          title="Delete notification"
                        >
                          <X className="h-4 w-4" />
                        </button>
